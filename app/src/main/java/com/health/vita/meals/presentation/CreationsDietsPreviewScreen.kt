...
@Composable
fun CreationsDietsPreviewScreen(
    navController: NavController = rememberNavController(),
    meal: Int
) {
    val dietsPreviewViewModel: CreationsDietsPreviewViewModel = viewModel(
    ...
    val meals by dietsPreviewViewModel.creations.observeAsState(emptyList())
