            ...
            Column(
                ...
                Column {
                    ObjectiveSelectionCard(
                        ...
                        onClick = { selectedObjective = "Perder peso" }
                    )
                    ...
                    ObjectiveSelectionCard(
                        ...
                        onClick = { selectedObjective = "Probar el coach de IA" }
                    )
                    ...
                    ObjectiveSelectionCard(
                        ...
                        onClick = { selectedObjective = "Ganar masa muscular" }
                    )
                    ...
                    ObjectiveSelectionCard(
                        ...
                        onClick = { selectedObjective = "Mejorar mi alimentación" }
                    )
                }
