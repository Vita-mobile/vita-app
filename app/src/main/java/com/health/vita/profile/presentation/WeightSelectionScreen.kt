...
import com.health.vita.profile.presentation.components.Ruler
import com.health.vita.ui.components.general.GeneralTopBar
import com.health.vita.ui.components.general.PrimaryIconButton

@Composable
fun WeightSelectionScreen(modifier: Modifier = Modifier, navController: NavController = rememberNavController()) {
    val maxKgs = 200
    val maxLbs = 400
    ...
    Column(
        ...
        Ruler(quantity = quantity, onValueChange = { newValue -> selectedValue = newValue })
